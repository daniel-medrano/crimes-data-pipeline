...
select * from dc23 where date = '2022-12-31' order by date desc limit 10;
...
SELECT * FROM TRANSFORMED.CRIMES LIMIT 10;
...
SELECT * FROM CONSUMPTION.DATE_DIMENSION;
...
insert into prueba1 values ('Guanacaste'), ('Guanacaste');
insert into prueba2 values ('San Jose');

drop table prueba2;

MERGE INTO prueba2 p2
    using (select provincia from prueba1) p1
    on (p1.provincia = p2.provincia)
when not matched then
    insert values (p1.provincia);
